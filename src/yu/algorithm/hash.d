...
uint SDBMHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint hash = 0;
...
// RS Hash Function
uint RSHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint b = 378551;
    uint a = 63689;
    uint hash = 0;
...
// JS Hash Function
uint JSHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
...
uint PJWHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
...
// ELF Hash Function
uint ELFHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint hash = 0;
    uint x    = 0;
...
// BKDR Hash Function
uint BKDRHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
...
// DJB Hash Function
uint DJBHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint hash = 5381;
...
// AP Hash Function
uint APHash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint hash = 0;
    foreach(i,ch; str)
    {
...
uint JKOhash(CHAR)(const CHAR[] str) if(isCharByte!CHAR)
{
    uint hash = 0;
    foreach(ch; str)
    {
...
size_t Murmur3Hash(CHAR)(const CHAR[] str, size_t seed = 0) if(isCharByte!CHAR)
{
